...
class YOLOv12Head(nn.Cell):
    # YOLOv12 Detect head for detection models
    ...
    def make_anchors(feats, strides, grid_cell_offset=0.5):
        """Generate anchors from features.根据特征图生成锚点坐标和对应的步长"""
    ...
    def dist2bbox(distance, anchor_points, xywh=True, axis=-1):
        """Transform distance(ltrb) to box(xywh or xyxy).将预测的距离值转换为边界框坐标"""
