...
def parse_model(d, ch, nc, sync_bn=False):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d.backbone + d.head):  # from, number, module, args
        ...
        if m in (
            ...
            if m in (DownC, SPPCSPC, C3, C2f, DWC3, C2fCIB, C3k2, C2PSA, A2C2f):
        ...
        elif m in (YOLOv12Head, YOLOv11Head, YOLOv10Head, YOLOv9Head, YOLOv8Head, YOLOv8SegHead, YOLOXHead):  # head of anchor free
            args.append([ch[x] for x in f])
