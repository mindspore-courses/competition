...
from mindformers.models.clip.clip_modules import Transformer, LayerNorm
from mindformers.models.clip.clip_config import CLIPConfig
...
class CLIPTextModel(BaseModel):
    ...
    def __init__(self, config: CLIPConfig):
        ...
        self.ms_tokenizer = CLIPTokenizer.from_pretrained('clip_vit_b_32')
    ...
    def construct(self, text: ms.Tensor):
        r"""Construct
        ...
        text = self.ms_tokenizer(text, max_length=77, padding="max_length", return_tensors="ms")["input_ids"]
        if len(text.shape) == 3:
            text = text[0].squeeze()
