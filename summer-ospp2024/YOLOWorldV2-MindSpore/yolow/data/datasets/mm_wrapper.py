...
#             data_info['dataset'] = self
#         data_info_tmp = self.pipeline(data_info)
#         data_info_tmp['inputs'] = [data_info_tmp['inputs'],]
#         data_info_tmp['data_samples'] = [data_info_tmp['data_samples'],]
        
#         return data_info_tmp
...
class MultiModalDataset:
    ...
    def __getitem__(self, idx):
        ...
        if hasattr(self.dataset, 'test_mode') and not self.dataset.test_mode:
            ...
            data_info['dataset'] = self
        data_pipeline = self.pipeline(data_info)
        data_info_tmp = {"inputs": [data_pipeline[0]['inputs'],], "data_samples": [data_pipeline[0]['data_samples'],]}
        return data_info_tmp
