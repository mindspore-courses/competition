...
def load_model_for_kbk(cfg: ServingConfig, rank_id: int, device_id: int):
    ...
    mindspore.set_context(inter_op_parallel_num=8)
    ...
    while True:
        ...
        while True:
            ...
            try:
                ...
                #profiler1.analyse()
                #print('===================================analysis finished profiler1======================================')
