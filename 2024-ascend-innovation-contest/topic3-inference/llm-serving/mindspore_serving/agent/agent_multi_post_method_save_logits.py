...
class WorkAgent:
    ...
    def predict_for_kbk(self, current_index, input_ids, valid_length, block_tables, slot_mapping):
        ...
        # logging.info("==============mindspore_model ouputs : %s;", outputs)
        ...
        # name_npy11 = str(predict_time) + '.npy'
        # logging.info(f"******************** name_npy11111: {name_npy11}")
        
        # name_npy = times_s = str(datetime.datetime.now()) + '_' + str(current_index[0]) + '.npy'
        # logging.info(f"******************** name_npy: {name_npy}")
        
        # tokens111 = ''.join(map(str, input_ids)) 
        # name_npy = tokens111 + '_' + str(current_index[0]) + '.npy'
        

        # fpath = os.path.join(save_path, name_npy)
