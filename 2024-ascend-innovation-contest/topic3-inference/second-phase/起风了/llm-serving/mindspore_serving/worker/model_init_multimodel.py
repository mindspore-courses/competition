...
class DisModel:
    ...
    def call(self, shms: List, input_ids, current_index,
        ...
        for decode_index in decode_index_list:
            ...
            ### liuyang
            # save_result.append(int(tmp[decode_index:decode_index + 1]))
        # if is_first_iteration:
        #     file_name = str(read_time)+'result1'
        # else:
        #     file_name = str(read_time)+'result2'
        # np.save(file_name, np.array(save_result))
