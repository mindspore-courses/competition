...
#     def construct(self, x):
#         # logger.info("outputs_np shape: {}".format(x.shape))
...
#         # print(x)
#         output = np.argmax(x, axis=-1) ### numpy的argmax也可以用于tensor
#         # logger.info("outputs value: {}".format(output))
#         return output
...
#     def __init__(self):
#         super(ArgmaxPost, self).__init__()
#         # self.argmax = mint.Argmax(output_type=ms.int32)
#         # self.reshape = ops.reshape()
