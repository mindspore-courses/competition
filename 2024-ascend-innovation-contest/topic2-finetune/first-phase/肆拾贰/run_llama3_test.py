...
def main(task='text_generation',
    ...
    with open(input_dir, 'r', encoding='utf-8') as file:
        ...
        for line in file:
            ...
            pro_list = "A chat between a curious user and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the user's questions. USER: " + line['problem'] + " ASSISTANT: "
