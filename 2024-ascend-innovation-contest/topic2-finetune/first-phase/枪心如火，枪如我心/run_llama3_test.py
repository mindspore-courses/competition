...
def main(task='text_generation',
    ...
    with open(input_dir, 'r', encoding='utf-8') as file:
        ...
        for line in file:
            ...
            predict_data.append(f'Below is an instruction that describes a task. Write a response that appropriately completes the request.\n\n### Instruction:\n{pro_list}\n\n### Response:')
    ...
    if run_mode == 'train':
        ...
        fpath = "/home/ma-user/work/math_eval_result.npy"
